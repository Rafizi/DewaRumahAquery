package com.naufalrafizi.dewarumah.AfterLogin.SC.DataProspekSC.Activity;
...
import com.naufalrafizi.dewarumah.AfterLogin.SC.DataProspekSC.Adapter.RecyclerViewAdapterDataProspekSC;
import com.naufalrafizi.dewarumah.R;

import java.util.ArrayList;
import java.util.List;

public class DataProspekSC extends AppCompatActivity {
    ...
    RecyclerViewAdapterDataProspekSC rvAdapterDataProspekSC;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        svProspek.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
            public boolean onQueryTextSubmit(String query) {
                rvAdapterDataProspekSC = new RecyclerViewAdapterDataProspekSC(getApplicationContext(),mList);
                rvProspek.setAdapter(rvAdapterDataProspekSC);
                return false;
            }
    ...
    private void startSearch(String text) {
        rvAdapterDataProspekSC = new RecyclerViewAdapterDataProspekSC(this,dbHelper.getSearchByName(text));
        rvProspek.setAdapter(rvAdapterDataProspekSC);
    }
